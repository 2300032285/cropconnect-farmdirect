-- Temporarily make farmer_id nullable for demo purposes
...
INSERT INTO public.products (name, description, category, price, unit, quantity_available, minimum_order, organic, harvest_date, expiry_date, location, image_url, status) VALUES
  ...
  ('Fresh Turmeric', 'Premium quality turmeric roots', 'herbs', 65.00, 'kg', 400, 10, false, '2024-01-05', '2025-01-05', 'Haryana', 'https://images.unsplash.com/photo-1596040033229-a292df4483d0?w=400', 'available'),
  ...
  ('Organic Apples', 'Fresh red apples from hill stations', 'fruits', 95.00, 'kg', 250, 5, true, '2024-01-20', '2024-03-20', 'Himachal Pradesh', 'https://images.unsplash.com/photo-1560806887-1e4cd0b6cbd6?w=400', 'available'),
  ('Fresh Mint', 'Aromatic mint leaves for culinary use', 'herbs', 40.00, 'kg', 80, 2, true, '2024-01-23', '2024-02-05', 'Maharashtra', 'https://images.unsplash.com/photo-1628556270448-4d4e4148e1b1?w=400', 'available');
